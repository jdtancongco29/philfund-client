...
export default function AddEditEntryDialog({ isOpen, onClose, onSave, editingEntry = null }: AddEditEntryDialogProps) {
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <Label className="text-lg font-semibold">
                Entry Items <span className="text-red-500">*</span>
              </Label>
                  <Button
                  variant="outline"
                  onClick={addItem}
          ...
          <Button variant="outline" onClick={handleClose} disabled={isSubmitting}>
            ...
            {!isEditMode && (
              <Button
                ...
                disabled={
                  isSubmitting || !name || !particulars || items.length === 0 || !isBalanced(items)
                }
              >
