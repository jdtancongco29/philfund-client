...
export const DistrictSetupService = {
  ...
  generateSchoolCode: async (): Promise<ApiResponse<{ data: string }>> => {
    const endpoint = "/borrower/district/generate-code";
    try {
  ...
  getAllDistricts: async (
    ...
    const response = await apiRequest<ApiResponse<GetAllDistrictsResponse>>(
      "get",
      endpoint,
      null,
      {
  ...
  getDistrictById: async (id: string): Promise<ApiResponse<DistrictDetail>> => {
    ...
    const response = await apiRequest<ApiResponse<DistrictDetail>>(
      "get",
      endpoint,
      null,
      {
  ...
  createDistrict: async (
    ...
    const endpoint = "/borrower/district";
    try {
      const response = await apiRequest<ApiResponse<District>>(
        "post",
        endpoint,
        payload,
        {
   ...
   */
  updateDistrictStatus: async (
    id: string,
    payload: UpdateDistrictStatusPayload
  ...
  exportPdf: async (): Promise<Blob> => {
    const endpoint = `/borrower/district/export-pdf`;
    try {
   ...
   */
  exportCsv: async () => {
    const endpoint = `/borrower/district/export-csv`;
    try {
