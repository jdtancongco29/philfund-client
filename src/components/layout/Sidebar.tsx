    ...
    items: [
      {
        ...
        links: [
          ...
          },
          {
            ...
            path: "/dashboard/cash-advance-processing",
            order: 2,
          },
          {
            label: "Loan Restructuring",
            path: "/dashboard/loan-restructuring",
            order: 3,
          },
          {
            label: "Cash Processing",
            path: "/dashboard/cash-processing",
            order: 4,
          },
          {
            label: "Payments & Collections",
            path: "/dashboard/payments-and-collections",
            order: 5,
          },
          { label: "Loan Pay Off", path: "/dashboard/loan-pay-off", order: 6 },
          {
            label: "Cards Custody Log",
            path: "/dashboard/cards-custody-log",
            order: 7,
          },
          {
            label: "Unsold / No Accounts Recording",
            path: "/dashboard/unsold-or-no-account-recording",
            order: 8,
          },
        ],
      },
