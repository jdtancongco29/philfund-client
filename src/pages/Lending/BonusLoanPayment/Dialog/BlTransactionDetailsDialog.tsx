...
import { BlTransactionDetailsTab } from "../Tabs/BlTransactionDetailsTab"
import { BlTransactionVoucherTab } from "../Tabs/BlTransactionVoucherTab"
...
export function BlTransactionDetailsDialog({ item, open, onOpenChange }: TransactionDetailsDialogProps) {
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex flex-col flex-grow overflow-hidden">
                    ...
                    <div className="flex-grow overflow-y-auto">
                        <TabsContent value="details" className="p-6 pt-0">
                            <BlTransactionDetailsTab item={item} receivedBy={receivedBy} setReceivedBy={setReceivedBy} />
                        </TabsContent>
                        <TabsContent value="voucher" className="p-6 pt-0">
                            <BlTransactionVoucherTab
                                item={item}
