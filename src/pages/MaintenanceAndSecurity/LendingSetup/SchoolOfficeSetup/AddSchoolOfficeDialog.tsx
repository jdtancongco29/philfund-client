...
interface AddSchoolOfficeDialogProps {
  open: boolean
...
export function AddDivisionDialog({ open, onOpenChange, onSubmit, borrowerGroups }: AddSchoolOfficeDialogProps) {
  // Initialize the form
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Add New School</DialogTitle>
        </DialogHeader>
        <Form {...form}>
